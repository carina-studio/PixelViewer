...
class CieChromaticityDiagram : Control
{
    ...
    public CieChromaticityDiagram()
    {
        ...
        this.GetObservable(DiagramBorderBrushProperty).Subscribe(new Observer<IBrush?>(_ => this.diagramPen = null));
        this.GetObservable(GridBrushProperty).Subscribe(new Observer<IBrush?>(_ => this.gridPen = null));
    }
