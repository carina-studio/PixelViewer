...
class ColorLutImageFilter : BaseImageFilter<ColorLutImageFilter.Params>
{
    ...
    public class Params : ImageFilterParams
    {
        ...
        /// </summary>
        public IList<double> AlphaLookupTable { get; set; } = Array.Empty<double>();

        /// <summary>
        /// Lookup table for blue color.
        /// </summary>
        public IList<double> BlueLookupTable { get; set; } = Array.Empty<double>();
        ...
        /// </summary>
        public IList<double> GreenLookupTable { get; set; } = Array.Empty<double>();

        /// <summary>
        /// Lookup table for red color.
        /// </summary>
        public IList<double> RedLookupTable { get; set; } = Array.Empty<double>();
    }
