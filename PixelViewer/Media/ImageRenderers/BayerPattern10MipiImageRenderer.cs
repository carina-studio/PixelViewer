...
/// </summary>
class BayerPattern10MipiImageRenderer() : BayerPatternImageRenderer(new ImageFormat(ImageFormatCategory.Bayer, "Bayer_Pattern_10_MIPI", true, new ImagePlaneDescriptor(0, 10, 10, true), [ "RAW10" ]))
{
