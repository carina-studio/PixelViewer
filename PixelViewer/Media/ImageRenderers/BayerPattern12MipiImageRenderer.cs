...
/// </summary>
class BayerPattern12MipiImageRenderer() : BayerPatternImageRenderer(new ImageFormat(ImageFormatCategory.Bayer, "Bayer_Pattern_12_MIPI", true, new ImagePlaneDescriptor(0, 12, 12, true), [ "RAW12" ]))
{
