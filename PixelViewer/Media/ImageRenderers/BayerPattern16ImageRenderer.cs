...
namespace Carina.PixelViewer.Media.ImageRenderers
{
    ...
    {
        public BayerPattern16ImageRenderer() : base(new ImageFormat(ImageFormatCategory.Bayer, "Bayer_Pattern_16", true, new ImagePlaneDescriptor(2, 9, 16, true), new string[]{ "RAW16" }))
        { }
