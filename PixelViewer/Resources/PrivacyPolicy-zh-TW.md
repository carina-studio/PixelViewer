...
## 適用範圍
PixelViewer 為 Carina Studio 之開放原始碼專案，採用 [MIT](https://github.com/carina-studio/PixelViewer/blob/master/LICENSE) 授權。以下所指 PixelViewer **僅包括** 與下列頁面所提供之可執行檔或壓縮檔內容完全相同之版本：
...
若您透過原始碼自行建置 PixelViewer，您使用該建置之版本僅受 [MIT](https://github.com/carina-studio/PixelViewer/blob/master/LICENSE) 授權之約束，不受本隱私權政策之約束。

本隱私權政策適用於您使用 PixelViewer 2026.0 及下一份隱私權政策所指定之版本之間 (但不包括) 的所有版本。
...
+ 應用程式錯誤的詳細資訊。
+ PixelViewer 確認是否有應用程式更新時，您的 **IP 位址**、**作業系統**及 **CPU 資訊**可能會被分享至 [GitHub](https://github.com)。關於 GitHub 如何處理這些資料，請參閱 [GitHub 隱私聲明](https://docs.github.com/zh/site-policy/privacy-policies/github-general-privacy-statement)。
...
## 個人資訊之使用
+ 所蒐集之資訊將用於偵錯用途 (例如分析應用程式錯誤)。在提供這些資訊之前，您可以檢視它們甚至拒絕提供這些資訊。
